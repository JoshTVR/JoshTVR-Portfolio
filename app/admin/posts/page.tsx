...
async function getPosts() {
  try {
    ...
    const { data } = await supabase
      .from('posts')
      .select('id,slug,title_en,title_es,excerpt_es,type,tags,is_published,shared_linkedin,shared_instagram,shared_facebook,shared_threads,published_at,scheduled_at,is_ai_generated,card_type,created_at')
