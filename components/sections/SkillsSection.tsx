  ...
  return (
    <section id="skills" className="section" style={{ background: 'var(--bg-primary)' }}>
      <div className="container">
        ...
        <h2 className="section-title reveal" style={{ marginBottom: '40px' }}>{title}</h2>
        ...
        >
          <div className="tech-ticker">
            {items.map((tech, i) => (
              <span key={i} style={{ display: 'inline-flex', alignItems: 'center', gap: '24px', whiteSpace: 'nowrap' }}>
                <span style={{
                  fontSize: '0.82rem',
                  fontWeight: 500,
                  color: 'var(--text-muted)',
                ...
                <span style={{ color: 'var(--accent)', opacity: 0.4, fontSize: '0.6rem' }}>◆</span>
              </span>
            ))}
          </div>
        </div>
