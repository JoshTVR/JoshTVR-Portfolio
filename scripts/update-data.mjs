...
const GITHUB_PROJECTS = [
  {
    ...
    demo_url: null,
    cover_image: 'https://raw.githubusercontent.com/JoshTVR/Business-Intelligence/main/img/BI.jpg',
    images: [],
    is_published: true,
    is_featured: true,
    sort_order: 9,
  },
  {
    ...
    demo_url: null,
    cover_image: 'https://matplotlib.org/stable/_static/logo2.svg',
    images: [],
    is_published: true,
    is_featured: false,
    sort_order: 10,
  },
  {
    ...
    demo_url: null,
    cover_image: 'https://raw.githubusercontent.com/JoshTVR/Data-Analitics-For-Digital-Businesses/main/Imgs/PythonPc.png',
    images: [],
    is_published: true,
    is_featured: false,
    sort_order: 11,
...
// ── 3. Update services ─────────────────────────────────────────────────────────
// price_from is in CENTS (e.g. $80 = 8000)
const SERVICES = [
  {
    ...
    features: ['Custom Blender model', 'Materials & textures', 'Up to 3 render outputs', 'Source file included', 'Delivered in 5 days'],
    price_from: 8000,
    currency: 'USD',
    category: '3d',
    delivery_days: 5,
  ...
  },
  {
    ...
    features: ['Up to 30 seconds', 'Cycles or EEVEE render', 'MP4 export', 'Background music optional', 'Delivered in 7 days'],
    price_from: 15000,
    currency: 'USD',
    category: 'video',
    delivery_days: 7,
  ...
  },
  {
    ...
    features: ['Unity XR build', 'Basic VR interactions', 'Environment design', '1 revision round', 'Delivered in 14 days'],
    price_from: 50000,
    currency: 'USD',
    category: 'vr',
    delivery_days: 14,
  ...
  },
  {
    ...
    features: ['Data cleaning included', 'Charts & visualizations', 'PDF or Notebook report', 'Dataset up to 100k rows', 'Delivered in 5 days'],
    price_from: 15000,
    currency: 'USD',
    category: 'data',
    delivery_days: 5,
  ...
  },
  {
    ...
    description_es: 'Gráficas, diagramas y exportaciones visuales de tus datos usando Python. Entregado como PNG/SVG listo para publicación o embebido en un Jupyter notebook.',
    features: ['Matplotlib / Seaborn / Plotly', 'PNG, SVG or HTML export', 'Your data or sample data', 'Source code included', 'Delivered in 3 days'],
    price_from: 8000,
    currency: 'USD',
    category: 'data',
    delivery_days: 3,
  ...
  },
  {
    ...
    features: ['Up to 5 screens', 'Desktop + mobile layouts', 'Clickable Figma prototype', 'Component library', 'Delivered in 4 days'],
    price_from: 10000,
    currency: 'USD',
    category: 'design',
    delivery_days: 4,
